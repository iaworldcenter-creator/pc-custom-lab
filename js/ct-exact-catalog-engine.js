                ...
                <div class="space-y-1 text-slate-300">
                    ${block2.map(c => `
                        <label for="cat_${c.id}" class="category-link flex items-center justify-between cursor-pointer hover:text-purple-300 transition">
                            <span class="flex items-center gap-3 truncate">
                                <input type="radio" id="cat_${c.id}" name="cat_facet" aria-label="${c.name}" ${activeSelectedCategory === c.id ? 'checked' : ''} onchange="window.selectCategoryFacet('${c.id}')" class="accent-purple-400 cursor-pointer shrink-0" />
                ...
                <div class="space-y-1 text-slate-300">
                    ${block3.map(c => `
                        <label for="cat_${c.id}" class="category-link flex items-center justify-between cursor-pointer hover:text-amber-300 transition">
                            <span class="flex items-center gap-3 truncate">
                                <input type="radio" id="cat_${c.id}" name="cat_facet" aria-label="${c.name}" ${activeSelectedCategory === c.id ? 'checked' : ''} onchange="window.selectCategoryFacet('${c.id}')" class="accent-amber-400 cursor-pointer shrink-0" />
